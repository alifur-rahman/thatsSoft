...
<body>
                    ...
                    <div class="col-md-4">
                        <form action="{{ route('LangChange') }}" method="GET">
                            ...
                            <select class="form-control Langchange" name="locale" onchange="this.form.submit()">
                                ...
                                <option value="it" {{ app()->getLocale() == 'it' ? 'selected' : '' }}>Italiano
                                </option>
                                <option value="pt" {{ app()->getLocale() == 'pt' ? 'selected' : '' }}>Português
                                </option>
                                <option value="da" {{ app()->getLocale() == 'da' ? 'selected' : '' }}>Dansk
                                </option>
                                <option value="nl" {{ app()->getLocale() == 'nl' ? 'selected' : '' }}>Nederlands
                                </option>
                            </select>
  ...
  <script src="{{ asset('assets/vendors/lodash/lodash.min.js') }}"></script>  --}}
    ...
    {{-- <script(src=`${CWD}vendors /gsap/drawSVGPlugin.js`)</script> --}}
